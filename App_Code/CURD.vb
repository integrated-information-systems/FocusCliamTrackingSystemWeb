...
Namespace Models
    Public Class CURD
        Protected Shared ConString As String = ConfigurationManager.ConnectionStrings("Custom_DB_ConnectionString").ToString
        Protected Shared SAPConString As String = ""
                    ...
                    Using cmd As New SqlCommand(Qry)
                        ...
                        If HasPrimaryKey Then
                            ...
                            If PrimaryKeyValueReader.Read Then
                                PrimaryKeyValue = PrimaryKeyValueReader("Id").ToString
                            End If
            ...
            Try
                ...
                Using SqlCon As New SqlConnection(ConString)
                    ...
                    For Each member As PropertyInfo In props.GetProperties
                        If member.Name <> "Id" Or HasPrimaryKey = False Then
