...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
  ...
  <%--<asp:BulletedList ID="PendingClaimList" runat="server" BulletStyle="Numbered" DisplayMode="LinkButton"
    ...
    <asp:GridView ID="DGPendingClaims" runat="server"  Width="100%"
        ...
        <Columns>
           ...
           <%-- <asp:BoundField DataField="EmailAddress" HeaderText="Email Address" 
            ...
            <asp:BoundField DataField="ClaimRemarks" HeaderText="Remarks" 
    ...
    <asp:SqlDataSource ID="SqlPendingClaims" runat="server" 
        ...
        SelectCommand="SELECT x.CreatedOn as 'RemarksUpdatedOn', SUBSTRING ( x.Remarks , 0, 50) as 'ClaimRemarks'  ,T1.* FROM [ClaimHeader] T1 OUTER APPLY(Select Top 1 CreatedOn, Remarks from ClaimRemarks T2 WHERE T1.ID=T2.ClaimId Order By T2.CreatedOn DESC ) x WHERE T1.Country=@country order by id desc">
        <SelectParameters>         
