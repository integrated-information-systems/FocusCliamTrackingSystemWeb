<%@ Page Title="" Language="VB" MasterPageFile="~/Site.master" AutoEventWireup="false" CodeFile="Claimform.aspx.vb" Inherits="Business_Claimform" EnableEventValidation="false" %>
    ...
    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Invoice Date">
                            <ItemTemplate>
                                <asp:TextBox runat="server"  Width="75px" id="InvDate" Text='<%# Bind("InvDate") %>'  >  </asp:TextBox> 
                         ...
                         <asp:TemplateField HeaderText="Invoice No">
                            <ItemTemplate>
                                <asp:TextBox runat="server" id="InvNo" Text='<%# Bind("InvNo") %>'  MaxLength="25" >  </asp:TextBox>                        
        ...
        <tr>
            ...
            <td valign="top">
                <table class="style1" style="border: 1px solid #DDE4EC;">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblreasonforrejection" runat="server" Text="Remarks"></asp:Label></td>
                        <td>
